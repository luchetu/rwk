        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><h3>{{ count($posts) }}</h3></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><h3>{{ count($tags)}}</h3></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><h3>{{ count($categories)}}</h3></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Stats',
            data: [{{ count($posts)}}, {{ count($tags)}}, {{ count($categories)}}, {{ count($posts)}}],
            backgroundColor: [
                'rgba(255, 99, 132, 0.7)',
                'rgba(54, 162, 235, 0.7)',
                'rgba(255, 206, 86, 0.7)',
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <a class="btn btn-app" href="/admin/posts">
                <span class="badge bg-green">{{ count($tags)}}</span>
                <i class="fa fa-barcode"></i> tags
              </a>
              <a class="btn btn-app" href="/admin/categories">
                <span class="badge bg-purple">{{ count($categories) }}</span>
                <i class="fa fa-users"></i> Categories
              </a>
              <a class="btn btn-app" href="/admin/posts">
                <span class="badge bg-teal">{{ count($posts)}}</span>
