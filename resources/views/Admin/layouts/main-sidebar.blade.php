...
<section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- Banners -->
        <li><a href=""><i class="fa fa-desktop"></i> <span>Banner</span></a></li>
        ...
        <li><a href="/admin/category"><i class="fa fa-shopping-cart"></i><span>Categories</span></a></li>
         <li><a href=""><i class="fa fa-shopping-cart"></i><span>Types</span></a></li>

        <li class="treeview"><a href=""><i class="fa fa-users"></i> <span>Accounts</span>
