            ...
            <div class="box-body">
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group" style="margin-top:18px;">
                  ...
                  <select class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select a State" style="width: 100%;" tabindex="-1" aria-hidden="true" name="tag_id">
                    @foreach ($tags as $tag)
                    <option value="{{ $tag->id }}"
